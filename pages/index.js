  ...
  return <div className='bg-primary/60 h-full overflow'>
    <div className='w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10'>
      ...
      <div className='text-center flex flex-col justify-center xl:pt-40 xl:text-left h-full container mx-auto'>
       <motion.h1 variants={fadeIn('down', 0.2)} initial="hidden" animate="show" exit="hidden" className='h1 mt-[90px] md:mt-0'>Fullstack <br/> {''} <span className='text-accent'>Web Develpoer</span></motion.h1>
      {/*sub title */}
